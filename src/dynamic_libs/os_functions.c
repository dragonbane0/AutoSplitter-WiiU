...
EXPORT_DECL(int, OSSetThreadRunQuantum, OSThread *thread, u32 quantum);
...
EXPORT_DECL(void, OSRestartGame, void*, void*); //0,0 fully reboots the current game
...
EXPORT_DECL(OSSystemInfo*, OSGetSystemInfo, void);
...
EXPORT_DECL(int, OSIsAddressValid, int addr);
...
//!----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
EXPORT_DECL(int64_t, OSGetTime, void);
EXPORT_DECL(void, OSTicksToCalendarTime, int64_t time, OSCalendarTime *calendarTime);
...
void InitOSFunctionPointers(void)
{
	...
	OS_FIND_EXPORT(coreinit_handle, OSGetSystemInfo);
